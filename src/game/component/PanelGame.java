...
//                                System.out.println("Removed.......");
            ...
            if (rocket != null) {
                ...
                if (!area.isEmpty()) {
                    ...
                    if (!rocket.updateHP(bullet.getSize())) {
                        ...
                        boomEffects.add(new Effect(x, y, 5, 5, 75, 0.1f, new Color(32, 0, 0)));
                        ...
                        boomEffects.add(new Effect(x, y, 12, 6, 180, 0.6f, new Color(240, 11, 233)));
    ...
    private void drawBackground() {
        g2.setColor(new Color(11, 17, 19));
...
//        player.draw(g2);
        ...
        if (!player.isAlive()) {
            ...
            String textKey = "Press the Enter Key to Continue ...";
